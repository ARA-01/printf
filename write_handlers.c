 ...
 * @flags: The Active Flags to be calculated.
 * @width: Get Width.
...
{ /* the character is stored at left and padding at buffer's right */
	int i = 0;
	char padd = ' ';
 ...
 * @is_negative: The arguments list.
...
/**
 * write_num - This function uses a buffer to write a number.
 * @ind: The number starts on the buffer at the index.
 * @buffer: The Buffer Array that handles the print.
 * @flags: The Active Flags to be calculated.
 * @width: Get Width.
...
/**
 * write_unsignd - This function that writes an unsigned number.
 * @is_negative: The number indicates if it is negative.
 * @ind: The index at which the number starts in the buffer.
 * @buffer: Array Buffer of CHARACTERS.
 * @flags: Active Flags specifiers
 ...
 * @buffer: Array Buffer of CHARACTERS.
 * @ind: The index at whcih the number starts in the buffer.
 * @length: The Length number.
 * @width: Width specifier.
 * @flags: Active Flags specifier
 * @padd: The CHARACTER that represents the padding.
 * @extra_c: represents an Extra CHARACTER.
