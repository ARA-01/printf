...
/****************** PRINT _A_ STRING _IN_ ROT 13 ******************/
/**
 * print_rot13string - This function prints a string in ROT 13.
		...
		int flags, int width, int precision, int size)
{
	...
	char out[] = "NOPQRSTUVWXYZABCDEFGHIKLMnopqrstuvwxyzabcdefghijklm";
